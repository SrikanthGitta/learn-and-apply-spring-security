package com.techstack.custom.oauth;
...
// TODO-1 Uncomment the below annotation to enable the configurations for Oauth Server endpoints and also their security Configurations
...
public class AuthorizationServerConfiguration extends AuthorizationServerConfigurerAdapter {
	...
	*/
    ...
    // TODO-5 uncomment the below method to permit all requests to check token. Now restart the application , get a new token and try to check token
    @Override
